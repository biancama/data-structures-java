...
public interface List<E> extends Iterable<E> {
	 ...
	 * @return the element in the first position or null
	 */
	E first();

	/**
	 * Returns the last element
	 * @return the element in the last position or null
	 */
	E last();

	/**
	 * Inserts the given element at the last position in the list,
	 * @param  e   the new element to be stored
	 * @throws IndexOutOfBoundsException if the index is negative or greater than size()
	 */
	void addLast(E e);
	...
	/**
	 * Inserts the given element in the first position of the list, shifting all
	 * subsequent elements in the list one position further to make room.
	 * @param  e   the new element to be stored
	 */
	void addFirst(E e);
	...
	/**
	 * Removes and returns the first element, shifting all subsequent
	 * elements in the list one position closer to the front.
	 * @return the element that had be stored at the given index
	 * @throws IndexOutOfBoundsException if the index is negative or greater than size()
	 */
